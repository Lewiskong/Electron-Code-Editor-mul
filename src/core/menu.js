...
const {Menu} = remote
const file = require('../util/file-io')
const Server=require('../util/httpUtil')
...
const template = [{
        ...
        submenu: [{
                ...
                label: 'AutoRefreshServer',
                accelerator: 'CmdOrCtrl+[',
                click(){
                    file.createAutoRefreshServer()
                }
...
MenuFactory.instance = null

MenuFactory.init = () => {
    if (!MenuFactory.instance) MenuFactory.instance = new MenuInitializer()
